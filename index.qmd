        ...
        <div class="carousel-item">
          <div class="experience-slide-six">
            ...
            <div class="experience-slide-text experience-slide-six-text">
              ...
              <p>Janna started a new job in Berlin, while Ben continued in Zurich. Two years of long-distance journeys back and forth followed, with Deutsche Bahn playing an unpredictable third wheel in our relationship. Countless hours were spent in purgatory on train platforms, waiting for delayed trains throughout Germany (never in Switzerland, of course). Far from being “wilderness years,” this period made the time we had together feel more intentional. And without Ben to do the cooking, Janna also rediscovered her love of “girl dinner” and eating chickpeas straight from the can.</p>
            </div>
          </div>
        </div>
        ...
        <ul class="timeline">
          <li class="timeline-item">
            ...
            <div class="timeline-body">
              ...
              <p class="card-text m-0">Arrive at Farmhouse Wandlitz, pitch your tent or find your room, and get settled.</p>
            </div>
          </li>
          <li class="timeline-item">
            ...
            <div class="timeline-body">
              ...
              <p class="card-text m-0">Games, relaxation & getting to know each other.</p>
            </div>
          </li>
          <li class="timeline-item">
            ...
            <div class="timeline-body">
              ...
              <p class="card-text m-0">Sharing a nice home-made dinner together and then getting some beauty sleep.</p>
            </div>
          </li>
        </ul>
      </div>
        ...
        <ul class="timeline">
          <li class="timeline-item">
            ...
            <div class="timeline-body">
              ...
              <p class="card-text m-0">A relaxed brunch to fuel up for the day.</p>
            </div>
          </li>
          <li class="timeline-item">
...
::: {.general-text}
As mentioned, there a variety of accomodation options at the venue itself but also in the nearby town which are described below. Obviously, the number of beds at the venue are limited so have included an option to specify your preference in the <a href="#sec-rsvp" >RSVP</a> and we will do our best to try and make everyone's preferred option work. If you have any questions about accomodation or need help finding something please don't hesitate to reach out to us.
:::
      ...
      <div class="stay-card-wrapper">
        <div class="stay-card">
          ...
          <div class="stay-card-back">
            <div class="card-img-overlay-bg" style="background-image: url('media/camping.jpg');"></div>
            <div class="card-body">
              <p class="card-text">Pitch your own tent in a quiet spot at the back of the grounds. There are multiple bathrooms nearby for you to use. 10 Euro per person</p>
            </div>
          </div>
        </div>
      </div>
...
```{=html}
<p class="general-text">Add your songs to the playlist <a href="https://open.spotify.com/playlist/6lcvHlV9jRY6rNHZp8keDb?si=Bi-1cV5xQ0iniM2dmsz-nw&pt=257fb731ce00844d27fcc2f6e8b7aac2&pi=QaondvveQ9uVj" target="_blank">here</a></p>

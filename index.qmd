        ...
        <ul class="timeline">
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-body">
              ...
              <p class="card-text m-0">Having a good time playing volleyball or table tennis, setting up and decorating, reading, soaking up the sunlight (hopefully) and playing games.</p>
            </div>
          </li>
          <li class="timeline-item">
...
# Our TrauzeugInnen {.section-title}

::: {.general-text}
We are so lucky to have such wonderful people in our lives, Anna and Nico, who have agreed to be our TrauzeugInnen. They will support us in organising some of the activities and any one who wants to lend a helping hand over the wedding, so keep an eye for them and feel free to ask them if you have any questions or want to get involved. Thank you both for being there for us!
...
```{=html}
<p class="general-text">	Add your favourite songs to the playlist here  <a href="https://open.spotify.com/playlist/6lcvHlV9jRY6rNHZp8keDb?si=rDkhgJqNQxmHyMDp4EResQ&pt=d9322366ed307626acdfb5ae27d949aa&pi=auJn7OKvRc-8h" target="_blank">here</a></p>
